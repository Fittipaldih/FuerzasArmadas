...
public class TestFuerza {
	...
	public void queSePuedaCrearUnObjetoAnfibio() {
		Anfibio var = new VehiculoAnfibio(12, "LARC-5");
	...
	public void queSePuedaCrearUnHidroavion() {
		HidroAvion ag600 = new VehiculoHidroAvion(12, "AG600");
	...
	public void queSePuedaArmarElConvoy() {
		...
		argentina.agregarVehiculo(new VehiculoHidroAvion(12, "Mitsubishi F1M"));
		
		// No se deberia poder agregar el siguiente, ya que es el mismo Codigo que el anterior (12)
		argentina.agregarVehiculo(new VehiculoAnfibio(12, "LARC-5"));
	...
	public void queSePuedaCrearUnaBatalla() {
		...
		Batalla batalla = (Batalla) argentina.getBatalla("San Lorenzo");
		
		Double latitud=0.0;
		Double longitud=0.0;
		
		if ( batalla != null ) {
			latitud = batalla.getLatitud();
			longitud = batalla.getLongitud();
		}
		
		assertNotNull(batalla);
		assertEquals(100.5, latitud,0.01);
		assertEquals(20.3, longitud,0.01);
	}	
	...
	public void queSePuedaPresentarBatallaTerrestre() throws VehiculoInexistente, VehiculoIncompatible {
		...
		argentina.agregarVehiculo(new Tanque(1, "Renault FT"));
		argentina.agregarVehiculo(new Camion(20, "T-72"));
		argentina.agregarVehiculo(new Camion(3, "T-72"));

		argentina.crearBatalla("San Lorenzo", TipoDeBatalla.TERRESTRE, 100.5, 20.3);

		assertTrue(argentina.enviarALaBatalla("San Lorenzo", 1));
		assertTrue(argentina.enviarALaBatalla("San Lorenzo", 20));
	...
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible {
		...
		argentina.agregarVehiculo(new Destructor(10, "A-10"));
		argentina.agregarVehiculo(new Destructor(11, "A-10"));
		argentina.agregarVehiculo(new VehiculoHidroAvion(12, "A-10"));
		argentina.agregarVehiculo(new VehiculoAnfibio(13, "A-10"));
		
		int valorObtenido = argentina.getCapacidadDeDefensa();
		assertEquals(6, valorObtenido );
